...
void LogSink::log(LogLevel level, const std::string& message, const std::source_location location) const
{
...
LogLevel LogSink::filterLogLevel() const
{
  return m_filterLogLevel;
}

void LogSink::setFilterLogLevel(LogLevel value)
{
  m_filterLogLevel = value;
}
