...
void log(Log::LogLevel logLevel, const std::string& message, const std::source_location location)
{
...
void logWarning(const std::string& message, const std::source_location location)
{
...
void logCritical(const std::string& message, const std::source_location location)
{
