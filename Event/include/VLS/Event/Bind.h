...
/// <remarks>
/// Class with static functions that create a callable std::function<void(...)>
/// from a member function with the same parameters. Any member function with 0
/// to 9 arguments can be bound in a callable with the same arguments.
/// </remarks>
class Func {
 public:
  /// <summary>
  /// Create a callable std::function<void(void)> from a void(void) member
  /// function.
  /// </summary>
  ...
  /// <summary>
  /// Create a callable std::function<void(T1, T2)> from a void(T1, T2) member
  /// function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  ...
  static std::function<void(T1, T2)> Bind(TObj* funcObj,
                                          void (TObj::*func)(T1, T2)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2);
  }

  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3)> from a void(T1, T2, T3)
  /// member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  ...
  /// <returns> Callable that returns void and takes three parameters.
  /// </returns>
  template <typename TObj, typename T1, typename T2, typename T3>
  static std::function<void(T1, T2, T3)> Bind(TObj* funcObj,
                                              void (TObj::*func)(T1, T2, T3)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3);
  }

  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4)> from a void(T1, T2,
  /// T3, T4) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  static std::function<void(T1, T2, T3, T4)> Bind(TObj* funcObj,
                                                  void (TObj::*func)(T1, T2, T3,
                                                                     T4)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3,
  ...
  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4, T5)> from a void(T1,
  /// T2, T3, T4, T5) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  template <typename TObj, typename T1, typename T2, typename T3, typename T4,
            typename T5>
  static std::function<void(T1, T2, T3, T4, T5)> Bind(
      TObj* funcObj, void (TObj::*func)(T1, T2, T3, T4, T5)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3,
  ...
  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4, T5, T6)> from a
  /// void(T1, T2, T3, T4, T5, T6) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  static std::function<void(T1, T2, T3, T4, T5, T6)> Bind(
      TObj* funcObj, void (TObj::*func)(T1, T2, T3, T4, T5, T6)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3,
                     std::placeholders::_4, std::placeholders::_5,
                     std::placeholders::_6);
  ...
  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4, T5, T6, T7)> from a
  /// void(T1, T2, T3, T4, T5, T6, T7) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  /// <returns> Callable that returns void and takes seven parameters.
  /// </returns>
  template <typename TObj, typename T1, typename T2, typename T3, typename T4,
            typename T5, typename T6, typename T7>
  static std::function<void(T1, T2, T3, T4, T5, T6, T7)> Bind(
      TObj* funcObj, void (TObj::*func)(T1, T2, T3, T4, T5, T6, T7)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3,
                     std::placeholders::_4, std::placeholders::_5,
  ...
  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4, T5, T6, T7, T8)> from
  /// a void(T1, T2, T3, T4, T5, T6, T7, T8) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  /// <returns> Callable that returns void and takes eight parameters.
  /// </returns>
  template <typename TObj, typename T1, typename T2, typename T3, typename T4,
            typename T5, typename T6, typename T7, typename T8>
  static std::function<void(T1, T2, T3, T4, T5, T6, T7, T8)> Bind(
      TObj* funcObj, void (TObj::*func)(T1, T2, T3, T4, T5, T6, T7, T8)) {
    return std::bind(
        func, funcObj, std::placeholders::_1, std::placeholders::_2,
        std::placeholders::_3, std::placeholders::_4, std::placeholders::_5,
        std::placeholders::_6, std::placeholders::_7, std::placeholders::_8);
  }

  /// <summary>
  /// Create a callable std::function<void(T1, T2, T3, T4, T5, T6, T7, T8, T9)>
  /// from a void(T1, T2, T3, T4, T5, T6, T7, T8, T9) member function.
  /// </summary>
  /// <typeparam  name="TObj"> Class of the funcObj. </typeparam >
  /// <typeparam  name="T1"> Type of the 1. function argument. </typeparam >
  /// <typeparam  name="T2"> Type of the 2. function argument. </typeparam >
  ...
  static std::function<void(T1, T2, T3, T4, T5, T6, T7, T8, T9)> Bind(
      TObj* funcObj, void (TObj::*func)(T1, T2, T3, T4, T5, T6, T7, T8, T9)) {
    return std::bind(func, funcObj, std::placeholders::_1,
                     std::placeholders::_2, std::placeholders::_3,
                     std::placeholders::_4, std::placeholders::_5,
                     std::placeholders::_6, std::placeholders::_7,
